...
class VerdeFragment : Fragment() {
    ...
    private var listener: ComunicadorInterfaces? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonVerde).setOnClickListener { listener?.onClickButtonSumar() }
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is ComunicadorInterfaces) {
            listener = context
        }
    }
